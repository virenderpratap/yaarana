            ...
            <div class="container">
                <div class="links links-left">
                    <ul>
                        ...
                        <li><a href="#"><i class="fa fa-envelope-open"></i> info@dummmy.com</a></li>
                        <!-- <li>
                            <select>
                                <option>EUR</option>
                                <option>FRA</option>
                    ...
                    <div class="navbar-flex">
                        ...
                        <div class="navbar-header">
                            <a class="navbar-brand" href="index.php">
                                <img src="images/logo-black.png" alt="image" style="width:255px;">
                            </a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav" id="responsive-menu">
                                ...
                                <li class="submenu dropdown">
                                    <a href="index-flights.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Flights</a>

                                </li>
                                <li class="submenu dropdown">
                                    <a href="index-hotel.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hotel</a>
                                </li>
                                <li class="submenu dropdown">
                                    <a href="index-cars.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Cars </a>
